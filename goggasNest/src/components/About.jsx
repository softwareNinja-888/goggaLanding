...
export function About() {
  return (
    <div className="flex flex-col lg:flex-row px-4 sm:px-6 md:px-10 py-10 gap-10 lg:gap-20" id="about">
      ...
      <div className="w-full lg:w-1/2">
        <div className="flex flex-col gap-5 w-full sm:w-11/12 mx-auto mt-4">
          ...
          <div className="w-full sm:w-10/12 mx-auto">
            <img src="/area/view.jpg" alt="Garden View" className="w-full h-auto rounded-xl shadow" />
          </div>
      ...
      {/* Right Column */}
      <div className="w-full lg:w-1/2">
        <img src="/area/viewBalcony.jpg" alt="Balcony View" className="w-full h-auto rounded-xl shadow hidden lg:block " />
      </div>
    </div>
  );
}
