    ...
    return (
        <>
           <div className="relative group ">
                ...
                <div className="flex lg:opacity-0 items-center justify-between border border-white bg-white py-2 text-xl font-playfairBold absolute bottom-5 w-11/12 h-20 rounded-xl px-5 mx-auto right-6 group-hover:opacity-100 transition-all duration-1000 ease-in-out">
                    <div>
                        {name}
                    </div>
                    <div>
