      ...
      >
        ...
        <nav className="flex flex-col space-y-4 text-lg font-poppins items-center">   
            {links.map((link,index)=>{
                return (
                    <Links key={link.id} linkName={link.text} href={link.href}/>
                )
            })}
        </nav>
